...
knitr::include_graphics("data/templates/uts_logo_new.png", dpi = NA)
```
...
Or like this: `r knitr::include_graphics("data/templates/uts_logo_new.png", dpi = NA)`
...
knitr::include_graphics("data/templates/DSI_copy_ODI_Data_Ethics_Canvas.pdf")
...
```{r wordcount, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
wordcountaddin:::text_stats()
```
...
knitr::include_graphics("data/templates/uts_logo.png")
...
You'll see above that I used a labelled the table, I did that by using the chunk name, and type like this: `\@ref(tab:Summaryweather`. Now, I can use that to refer to it like this \@ref(tab:Summaryweather)
